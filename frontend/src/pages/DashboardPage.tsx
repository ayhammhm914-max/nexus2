...
export const DashboardPage = () => {
  ...
  return (
    <section className="mx-auto min-h-[70vh] max-w-4xl px-4 py-16 sm:px-6" dir={dir}>
      <div className="rounded-[32px] border border-white/10 bg-panel/80 p-8 shadow-card">
        <div className="text-sm uppercase tracking-[0.28em] text-primary">{t("dashboard.eyebrow")}</div>
