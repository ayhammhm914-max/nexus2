        ...
        <>
          ...
          >
            <div className="mb-6 flex items-center justify-between">
              <div>
                <div className="font-display text-lg tracking-[0.22em] text-white">Cart Vault</div>
                <div className="text-sm text-muted">{items.length} items ready</div>
              </div>
                  ...
                  <div key={item.productId} className="rounded-3xl border border-white/10 bg-white/5 p-4">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <div className="mt-1 text-sm text-muted">Qty {item.quantity}</div>
                      </div>
                      <button
